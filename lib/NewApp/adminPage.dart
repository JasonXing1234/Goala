...
import 'package:Goala/NewApp/updateOrderStatusPage.dart';
...
class _OrderListPageState extends State<adminPage> {
  ...
  Future<void> _fetchOrders() async {
    try {
      ...
      if (user != null) {
        ...
        final ordersRef = _database.child('orders');
          ...
          return ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => updateOrderStatusPage(order: order),
                ),
              );
            },
          );
