...
class CurrentProfileHeader extends StatefulWidget {
  final UserModel? userModel;

  CurrentProfileHeader({required this.userModel});

  @override
  State<StatefulWidget> createState() => _CurrentProfileHeaderState();
}

class _CurrentProfileHeaderState extends State<CurrentProfileHeader> {
